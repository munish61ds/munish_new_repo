													...
													<div class="cart_sidebar">
														<ul class="list-group">
															<li>
																...
																<a href="{{ route('student.dashboard') }}" class="cart-btn btn-cart cart-text notify-btn f-13 w-50 mt-3">@translate(See all notifications)</a>
															</li>
														</ul>
						...
						@guest
							<div class="logo-right-button">
								<ul id="custom_toggle_bar" class="d-flex">
									<li class="pr-2">
										<a href="{{route('instructor.register')}}" class="theme-btn instructor-btn">Trainer</a>
									</li>
									<li>
										<a href="{{route('student.register')}}" class="theme-btn student-btn">@translate(Student)</a>
									</li>
									@if (!request()->is('student/*'))
										<li class="login_li">
											<a href="{{ route('login') }}" class="login_anchor">@translate(Login)</a></li>
										</li>
									@endif
								</ul>
								<div class="side-menu-open">

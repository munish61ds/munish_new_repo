    ...
    <div class="card m-b-30">
        <div class="row p-3">
            <div class="col-md-6 border border-info">
                <div class="card">
                   <h3><strong>@translate(Test Name)</strong></h3>
                    <h4>{{$test->name}}</h4>
                </div>
            </div>
            <div class="col-md-3 border border-info">
                <div class="p-3 card">
                    ...
                    <h4>{{$test->pass_mark}}</h4>
                </div>
            </div>
            <div class="col-md-3 border border-info">
                <div class="p-3 card">
                    <h3><strong>@translate(test_time)</strong></h3>
                    <h4>{{$test->test_time ?? 'infinity'}}</h4>
                </div>
            </div>
        </div>
        <h4 class="card-header">@translate(Create New Questions)</h4>
        <div class="card-body mx-3">
            <form action="{{route('evaluation-test.questions.store')}}" method="post"  enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="switchery-list">
                                <input type="checkbox" data-url="{{route('evaluation-test.questions.published')}}"
                                       data-id="{{$item->id}}"
                            ...
                            <div class="kanban-menu">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right action-btn"
                                        ...
                                        <a class="dropdown-item" onclick="forModal('{{route('evaluation-test.questions.edit',$item->id)}}','@translate(Edit Question)')">
                                            <i class="feather icon-edit mr-2"></i>@translate(Edit)
                                        </a>
                                        <a class="dropdown-item"
                                           onclick="confirm_modal('{{ route('evaluation-test.questions.delete', $item->id) }}')"
                                           href="#!">
